...
use FakeData\Calculator\Iban;
use FakeData\Calculator\Luhn;
...
class Payment extends Base
{
    ...
    {
        if ($valid) {
            return $this->generator->callAnonymous('dateTimeBetween', ['now', '36 months']);
        }

        return $this->generator->callAnonymous('dateTimeBetween', ['-36 months', '36 months']);
    }
    ...
    public function creditCardDetails($valid = true)
    {
        ...
        return [
            ...
            'name' => $this->generator->callAnonymous('name'),
