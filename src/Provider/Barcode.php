...
use FakeData\Calculator\Ean;
use FakeData\Calculator\Isbn;
...
class Barcode extends Base
{
     ...
     *
     * @deprecated Use \FakeData\Calculator\Ean::checksum() instead
     *
     * @param string $input
     *
     * @return int
     ...
     * @deprecated Use \FakeData\Calculator\Isbn::checksum() instead
     *
